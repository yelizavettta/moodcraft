...
function renderPracticeContent() {
    const workouts = [
        ...
        { title: 'Суставы в порядке за 14 минут', 
          duration: '14 мин', 
          vk_oid: '-225618885', 
          vk_vid: '456239391', 
          channel: 'ЗДОРОВЫЙ ФИТНЕС', 
          views: '250 тыс.' },

        { title: 'Функционально-силовая тренировка на все тело', 
          duration: '60 мин', 
          vk_oid: '-219356990', 
          vk_vid: '456240575', 
          channel: 'sindirina1', 
        ...
        { title: 'Тренировка на все тело с гирей', 
          duration: '20 мин', 
          vk_oid: '-232841308', 
          vk_vid: '456242842', 
          channel: 'Yogasfera', 
        ...
        { title: 'ЛУЧШИЕ УПРАЖНЕНИЯ, ЧТОБЫ ПОХУДЕТЬ', 
          duration: '10 мин', 
          vk_oid: '-23871990', 
          vk_vid: '456241155', 
          channel: 'Антонина Верьёмина', 
          views: '412 тыс.' },

        { title: 'ТРАНСФОРМАЦИЯ_РУК_И_СПИНЫ', 
          duration: '40 мин', 
          vk_oid: '-237551639', 
          vk_vid: '456239083', 
          channel: 'Делай Тело: Просто начни', 
          views: '288 тыс.' },

        { title: 'Убираем БОЛЬ и прогиб в ПОЯСНИЦЕ', 
          duration: '30 мин', 
          vk_oid: '-227454512', 
          vk_vid: '456239214', 
          channel: 'СТАСЯ|Тренировки для здорового тела', 
          views: '345 тыс.' }
    ];
    const meditations = [
